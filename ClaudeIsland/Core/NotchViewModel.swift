...
class NotchViewModel: ObservableObject {
    ...
    private let creatureSelector = CreatureSelector.shared
    ...
    var openedSize: CGSize {
        ...
        case .menu:
            ...
            return CGSize(
                ...
                height: 420 + screenSelector.expandedPickerHeight + soundSelector.expandedPickerHeight + creatureSelector.expandedPickerHeight
            )
        case .instances:
            return CGSize(
                width: min(screenRect.width * 0.4, 480),
